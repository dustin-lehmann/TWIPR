...
class Interface:
    ...
    # === INIT =========================================================================================================
    def __init__(self, type: str, device_class: str = None, device_type: str = None, name: str = None, id: str = None):
    ...
    # ------------------------------------------------------------------------------------------------------------------
    def registerCallback(self, callback_id, function: callable, parameters: dict = None, lambdas: dict = None, **kwargs):
    ...
    def _handler_readMessage(self, data):
        logging.warning("Eval messages are not implemented yet")
