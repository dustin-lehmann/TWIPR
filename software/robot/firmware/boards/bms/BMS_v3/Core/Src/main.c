  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  if (HAL_GPIO_ReadPin(DETECT_CHG_GPIO_Port, DETECT_CHG_Pin)) {
		  ...
		  HAL_GPIO_WritePin(OUT_4_GPIO_Port, OUT_3_Pin, 1);
	  } else {
		  HAL_GPIO_WritePin(OUT_1_GPIO_Port, OUT_1_Pin, 0);
		  HAL_GPIO_WritePin(OUT_2_GPIO_Port, OUT_2_Pin, 0);
		  HAL_GPIO_WritePin(OUT_4_GPIO_Port, OUT_3_Pin, 0);
	  }
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin : ADC_CELL_3_Pin */
  ...
  /*Configure GPIO pin : ADC_CELL_4_Pin */
