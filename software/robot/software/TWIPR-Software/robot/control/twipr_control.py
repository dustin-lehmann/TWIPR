...
import robot.control.serial_communication_control as serial_communication_control
...
class TWIPR_Control:
    ...
    def setInput(self, input):
        ...
        if self.mode_ll == TWIPR_Control_Mode_LL.TWIPR_CONTROL_MODE_LL_BALANCING:
            input[0] = input[0] + self.settings['torque_offsets'][0]
            input[1] = input[1] + self.settings['torque_offsets'][1]
