...
class TWIPR_Sensors:
    ...
    def __init__(self, comm: TWIPR_Communication):
        ...
        self._comm.wifi.addCommand(identifier='resetEncoder',
                                   callback=self.setZeroPointEncoder,
                                   arguments=[],
                                   description='Reset Pendulum Encoder')

    # ------------------------------------------------------------------------------------------------------------------

    def setZeroPointEncoder(self):
        self._comm.serial.executeFunction(address=0x04, module=0x01)
